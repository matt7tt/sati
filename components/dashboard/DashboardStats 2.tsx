        ...
        <CardContent>
          <Tabs defaultValue="nutrition" className="w-full">
            ...
            <TabsContent value="accountability" className="space-y-4">
              ...
              <div className="space-y-2">
                <Text size="sm" className="font-semibold">Objective:</Text>
                <Text size="sm">{treatmentPlans.accountability.objective}</Text>
                <Text size="sm" className="font-semibold mt-4">Details:</Text>
                <Text size="sm">{treatmentPlans.accountability.details}</Text>
                <Text size="sm" className="font-semibold mt-4">Recommendations:</Text>
                <ul className="space-y-2 pl-6">
                ...
                {treatmentPlans.accountability.lastUpdated && (
                  <Text size="sm" className="text-muted-foreground mt-4">
                    Last updated: {new Date(treatmentPlans.accountability.lastUpdated).toLocaleDateString()}
                  </Text>
                )}
              </div>
              <div className="pt-4">
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => generatePDF(treatmentPlans.accountability)}
                >
                  Download Accountability Plan PDF
                </Button>
              </div>
            </TabsContent>
          </Tabs>
